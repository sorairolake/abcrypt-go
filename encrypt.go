...
func NewEncryptorWithParams(
	plaintext, passphrase []byte,
	memoryCost, timeCost uint32,
	parallelism uint8,
) *Encryptor {
	return NewEncryptorWithContext(
		plaintext,
		passphrase,
		defaultArgon2Type,
		memoryCost,
